...
\begin{enumerate}
  ...
  onde:
  \begin{itemize}
    \item $I_{ia}$, $I_{ib}$ e $I_{ic}$: correntes injetadas na barra \textit{i};
    
    \item $S_{ia}$, $S_{ib}$ e $S_{ic}$: potências injetadas na barra \textit{i};
    
    \item $V_{ia}$, $V_{ib}$ e $V_{ic}$: tensões na barra \textit{i};
    
    \item $Y_{ia}$, $Y_{ib}$ e $Y_{ic}$: admitância dos elementos \textit{shunt} conectados a barra \textit{i};
    
    \item \textit{k}: número da iteração.
  \end{itemize}

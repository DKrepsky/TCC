...
onde:
\begin{itemize}
    \item \emph{s}: nó fonte;
    \item \emph{r}: nó à jusante;
    \item \emph{$V_s$}: módulo da tensão em \emph{s};
    \item \emph{$V_r$}: módulo da tensão em \emph{r};
    \item \emph{P}: potência ativa equivalente da carga em \emph{r}; 
    \item \emph{Q}: potência reativa equivalente da carga em \emph{r}; 

...
Para a execução do algoritmo, deve-se assumir um perfil de tensão inicial, geralmente 1 pu.

No inicio do processo iterativo, o primeiro passo é determinar corrente na barra através da equação \ref{equ:ishirm}.
...
Para o caso onde os elementos \textit{shunt} possuem potência constante  
